# TP_0_ICT301_BITJONG_THEODORE
depot pour heberger le 1er tp ICT301 25-26

# nom: BITJONG
# prenom: THEODORE WILFRIED
# matricule: 23U2331

# Description des principes SOLID:
    breve description des pricipes SOLID suivant: SRP, OCP, LSP,  ISP, DIP
...
#  Description du principe DIP
    Les dépendances d’une classe ne devraient pas être concrètes: Elle ne doit pas connaître l’implémentation de ses dépendances
